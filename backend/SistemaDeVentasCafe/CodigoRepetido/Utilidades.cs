...
namespace SistemaDeVentasCafe.CodigoRepetido
{
    public class Utilidades
    {
        ...
        public static APIResponse GeneradorQR(APIResponse apiresponse, Mediodepago mediodepago)
        {
            QRCodeGenerator qrGenerator = new QRCodeGenerator();
            QRCodeData qRCodeData = qrGenerator.CreateQrCode(mediodepago.Descripcion, QRCodeGenerator.ECCLevel.Q);
            ...
            apiresponse.statusCode = HttpStatusCode.OK;
            apiresponse.fueExitoso = true;
            apiresponse.Resultado = mediodepago;
            apiresponse.qr = model;
            return apiresponse;
        }
